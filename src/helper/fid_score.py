...
# credits: https://github.com/mseitzer/pytorch-fid/blob/master/src/pytorch_fid/fid_score.py
...
from helper.inception import InceptionV3
...
def calculate_fid_given_paths(data_type, paths, batch_size, device, dims, num_workers=1):
